...
def calc_co2(
    ...
    if input_in_gravimetric_units:
        ...
        return co2aq * rho_ref * 1.0e3  # convert to mmol/m^3
...
def calc_dic(
    ...
    pco2_loc = pCO2 * 1e-6  # atm
    k0 = co2sol(S, T, return_in_gravimetric_units=True)  # mol/kg/atm
    ...
    return dic * 1e3 * rho_ref
    if not input_in_gravimetric_units:
        return dic * 1.0e3 * rho_ref  # convert to mmol/m^3
    else:
